# Generated by Django 5.0.4 on 2024-04-27 20:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BigRegion',
            fields=[
                ('big_region_id', models.IntegerField(primary_key=True, serialize=False)),
                ('name', models.TextField(max_length=200)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='FederalVote',
            fields=[
                ('region_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='main.region')),
        ...
        migrations.CreateModel(
            name='TrailVote',
            fields=[
                ('trail_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='main.trail')),
                ('count_of_votes', models.IntegerField()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('region_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='main.region')),
                ('count_of_votes', models.IntegerField()),
                ('big_region_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.bigregion')),
            ],
        ),
    ]
